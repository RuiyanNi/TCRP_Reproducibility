...
def get_zero_shot_unseen_data_loader(feature, label, batch_size=1):

	index_list = np.random.permutation(feature.shape[0])

	train_feature = torch.FloatTensor( 0)
	train_label = torch.FloatTensor( 0 )

	test_feature = torch.FloatTensor( feature )
